...
<title>Daftar Barang Dagangan</title>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php 
                        ...
                        $sql=sqlsrv_query($conn, "SELECT * FROM produk WHERE email_penjual = '$_SESSION[user]' AND stok != 0 "); 
                        while ($data=sqlsrv_fetch_array($sql)){ 
                            echo "<tr>
                                    ...
                                    <td>
                                        ...
                                        <button class='btn btn-xs btn-danger' type='submit' name='idproduk' value='$data[ID_Produk]'>edit</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='delete-dagangan.php' method='get'>
                                        <button class='btn btn-xs btn-danger' type='submit' name='idproduk' value='$data[ID_Produk]'>delete</button>
                                        </form>
                                    </td>
                                </tr>";
